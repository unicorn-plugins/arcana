...
- **TASK**: 마스터 기획서의 목차를 읽고 아트 기획 관련 챕터를 찾아, 해당 챕터 전체와 내부문서 3종(아트컨셉, 캐릭터비주얼컨셉, 카드컨셉문서)을 분석하여 현재 비주얼 방향성 파악
- **EXPECTED OUTCOME**: 아트 기획 현황 보고서 (톤, 색상 팔레트, 카드 프레임 현황)
- **MUST DO**: 아트 기획 관련 챕터 전체 헤더 스캔 후 누락 항목 파악
...
1. 비주얼 아이덴티티 가이드의 톤/색상 팔레트가 마스터 기획서 아트 기획 설정과 일치하는지 확인
